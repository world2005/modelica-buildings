...
model Flexlab "Block that exchanges a vector of real values with flexlab"
...
algorithm
  when {sampleTrigger} then
    ...
    // Exchange data
    yR :=Buildings.Utilities.IO.Python27.Functions.flexlab(
      ...
      nStrWri=nStrWri+2,
      nStrRea=nStrRea,
      strWri=vector([usrName; usrPwd; strWri]),
      strRea=strRea);
